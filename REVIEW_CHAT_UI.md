...
_Review based on static code analysis of the Hermes Workspace UI codebase._
_Files examined: chat-screen.tsx, chat-queries.ts, use-chat-history.ts, use-chat-mode.ts, gateway-capabilities.ts, task-store.ts_
