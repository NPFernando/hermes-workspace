...
| B | planned | Build `readPersonalFinancePostgresStore()` — reconstruct the JS shapes from all ~27 tables, verified with round-trip tests before it's ever wired into a real read path. |
