...
| AI-202 | Saved Q&A History | planned — deliberately deferred, ephemeral client-side state only for this slice |
| AI-203 | Chart/Visualization Answers | planned |
| AI-204 | Multi-Turn Conversation | planned — each question today is independent, no conversation memory |
