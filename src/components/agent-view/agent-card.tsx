    ...
    return (
      ...
      >
        ...
        <div className="mb-3 rounded-xl border border-[var(--theme-border)]/30 bg-[var(--theme-hover)]/24 p-2.5">
          <p className="mb-1 text-[10px] font-medium text-[var(--theme-muted)]">
            Last message
          </p>
    ...
    >
          ...
          <div className="flex items-start gap-2.5 overflow-visible">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-start gap-2">
                <h4
                  className="min-w-0 flex-1 truncate text-sm font-semibold text-[var(--theme-text)]"
                  title={node.name}
                >
                  {node.name}
                </h4>
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div className="flex-1 min-w-0 pt-0.5">
            <div className="flex items-center gap-1.5 flex-wrap">
              <h4
                className="truncate font-medium text-[var(--theme-text)] text-xs"
                title={node.name}
              >
                {node.name}
              </h4>
      ...
      {!isCompact ? (
        <div className="mt-2 max-h-0 overflow-hidden text-[var(--theme-muted)] tabular-nums opacity-0 transition-all duration-200 group-hover:max-h-48 group-hover:opacity-100">
          <p className="line-clamp-2 text-pretty text-[11px] text-[var(--theme-muted)]">
            {node.task}
          </p>
          <p className="mt-0.5 truncate text-[10px] tabular-nums text-[var(--theme-muted)]">
            {formatRuntime(node.runtimeSeconds)} ·{' '}
