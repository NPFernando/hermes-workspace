...
export function DashboardOverflowPanel({ open, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[80] no-swipe md:hidden">
      ...
      <div className="absolute inset-x-0 bottom-0 max-h-[85dvh] overflow-y-auto rounded-t-2xl border border-[var(--theme-border)] bg-[var(--theme-panel)] p-4 pb-[calc(env(safe-area-inset-bottom)+5rem)] shadow-2xl animate-in slide-in-from-bottom-4 duration-200">
