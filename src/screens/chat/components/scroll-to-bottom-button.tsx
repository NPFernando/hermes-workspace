    ...
    <AnimatePresence>
      {isVisible ? (
        ...
        >
          ...
          {unreadCount > 0 ? (
            <span className="absolute -right-1 -top-1 inline-flex min-w-5 items-center justify-center rounded-full bg-[var(--theme-bg)] px-1.5 text-xs font-medium tabular-nums text-[var(--theme-text)]">
