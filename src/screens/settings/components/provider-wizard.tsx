...
export function ProviderWizard({
  ...
  const verifyBorderColor =
    verifyState === 'success'
      ...
      : verifyState === 'warning'
        ...
        : 'border-[var(--theme-border)] bg-[var(--theme-hover)]/70'
  ...
  return (
    <DialogRoot open={open} onOpenChange={handleDialogOpenChange}>
      <DialogContent className="left-auto right-0 top-[var(--titlebar-h,0px)] h-[calc(100dvh-var(--titlebar-h,0px))] w-screen translate-x-0 translate-y-0 overflow-hidden rounded-none border-[var(--theme-border)] bg-[var(--theme-panel)]/95 backdrop-blur-sm duration-300 ease-out sm:w-[min(860px,100vw)] sm:rounded-l-2xl data-[state=open]:scale-100 data-[state=closed]:scale-100 data-[state=open]:translate-x-0 data-[state=closed]:translate-x-full">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-4 sm:px-5 sm:pb-5">
                  ...
                  {PROVIDER_CATALOG.map(function mapProvider(provider) {
                    return (
                      <button
                        ...
                        className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-panel)]/70 p-3 text-left transition-colors hover:border-[var(--theme-accent)] hover:bg-[var(--theme-hover)]/70"
                      >
                        ...
                        <p className="mt-2 text-xs text-[var(--theme-muted)] text-pretty line-clamp-2">
                        ...
                        <div className="mt-3 flex flex-wrap gap-1.5">
                          {provider.authTypes.map(function mapAuth(authType) {
                            return (
                              <span
                                key={authType}
                                className="rounded-full border border-[var(--theme-border)] bg-[var(--theme-hover)] px-2 py-0.5 text-xs text-[var(--theme-muted)]"
                              >
            ...
            {step === 'auth' && selectedProvider ? (
              <section className="mt-5">
                ...
                <div className="mt-3 rounded-xl border border-[var(--theme-border)] bg-[var(--theme-hover)]/70 px-3 py-2">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          supported
                            ? 'border-[var(--theme-border)] bg-[var(--theme-panel)]/70 hover:border-[var(--theme-accent)] hover:bg-[var(--theme-hover)]/80'
                            : 'cursor-not-allowed border-[var(--theme-border)] bg-[var(--theme-panel)]/40 opacity-50',
                        )}
                      >
                        <h4 className="text-sm font-medium text-[var(--theme-text)] text-balance">
                          {meta.title}
              ...
              <section className="mt-5">
                ...
                {selectedAuthType === 'oauth' ? (
                  <>
                    <p className="mt-1 text-sm text-[var(--theme-muted)] text-pretty">
                      This will run{' '}
                      <code className="font-mono text-[var(--theme-text)]">
                        hermes setup
                      </code>{' '}
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                      ...
                      <div className="rounded-xl border border-[var(--theme-border)] bg-[var(--theme-hover)]/70 px-3 py-2">
                        <p className="text-xs text-[var(--theme-muted)] text-pretty">
                          In the terminal, run:
                        </p>
                        <pre className="mt-1 rounded-lg bg-[var(--theme-hover)]/60 px-2 py-1.5 text-xs font-mono text-[var(--theme-text)]">
                          hermes setup
                        </pre>
                        <p className="mt-1.5 text-xs text-[var(--theme-muted)] text-pretty">
                      ...
                      <div className="rounded-xl border border-[var(--theme-border)] bg-[var(--theme-hover)]/70 px-3 py-2">
                        <p className="text-xs text-[var(--theme-muted)] text-pretty">
                          ...
                          <a
                            ...
                            className="text-[var(--theme-text)] underline decoration-primary-400 hover:text-[var(--theme-text)]"
                          >
                  ...
                  <>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-3 inline-flex items-center gap-1 text-sm text-[var(--theme-muted)] underline decoration-primary-400 hover:text-[var(--theme-text)]"
                    >
                      <HugeiconsIcon
                        icon={Link01Icon}
                        size={20}
                    ...
                    <div className="mt-4 rounded-xl border border-[var(--theme-border)] bg-[var(--theme-hover)]/70 px-3 py-2">
                      <p className="text-xs text-[var(--theme-muted)] text-pretty">
                    ...
                    <button
                      ...
                      className="mt-3 text-xs text-[var(--theme-muted)] hover:text-[var(--theme-muted)] underline"
                    >
                    ...
                    {showManualSnippet ? (
                      <div className="mt-2">
                        ...
                        <pre className="overflow-x-auto rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-hover)]/80 p-3 text-xs text-[var(--theme-text)]">
