...
function ResetEnvironmentSection() {
  ...
  return (
    <section className="mx-auto w-full max-w-[1480px]">
      <div className="rounded-2xl border border-primary-200 bg-primary-50/80 p-4 shadow-sm md:p-5">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h3 className="text-sm font-semibold text-primary-900">Reset Environment</h3>
