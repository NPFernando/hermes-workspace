        ...
        {edges.map((edge, index) => {
          ...
          return (
            <line
              ...
              x2={target.x}
              y2={target.y}
              stroke="color-mix(in srgb, var(--theme-muted) 45%, transparent)"
              strokeWidth="1.25"
            />
          )
        })}
        ...
        {layout.map((node) => (
          ...
          >
            <circle
              ...
              stroke="color-mix(in srgb, var(--theme-accent) 65%, transparent)"
              strokeWidth="1.5"
            />
            <text
              x={node.x}
...
export function KnowledgeBrowserScreen() {
  ...
  return (
    ...
    >
      <div className="flex w-full min-h-0 flex-col px-4 py-6 sm:px-6 lg:px-8">
        <div className="px-3 py-3 md:px-4 border-b border-[var(--theme-border)] bg-[var(--theme-bg)]">
          <div className="flex flex-col gap-3 md:flex-row md:items-center">
            <div className="flex min-w-0 flex-1 items-center gap-3">
              ...
              <div className="relative min-w-0 flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl py-2 pl-9 pr-3 text-sm outline-none transition-colors focus:border-accent-500 border border-[var(--theme-border)] bg-[var(--theme-card)] text-[var(--theme-text)]"
                />
              </div>
            </div>
            ...
            <DialogRoot open={settingsOpen} onOpenChange={setSettingsOpen}>
              ...
              <DialogContent className="sm:max-w-md bg-[var(--theme-bg)] text-[var(--theme-text)] border border-[var(--theme-border)]">
                <div className="space-y-4">
                  <div>
                    <DialogTitle className="text-base font-semibold">
                      Knowledge Base Settings
                    </DialogTitle>
                    <DialogDescription className="mt-1 text-sm text-[var(--theme-muted)]">
                  ...
                  {settingsSource?.type === 'local' && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border px-3 py-2 text-sm outline-none border-[var(--theme-border)] bg-[var(--theme-card)] text-[var(--theme-text)]"
                      />
                    </div>
                  )}
                  ...
                  {settingsSource?.type === 'github' && (
                    <div className="space-y-3">
                      ...
                      {syncError && (
                        <p className="rounded-lg border border-[var(--theme-danger)] bg-[color-mix(in_srgb,var(--theme-danger)_10%,transparent)] px-3 py-2 text-xs text-[var(--theme-danger)]">
                          {syncError}
                        </p>
                      )}
                    </div>
