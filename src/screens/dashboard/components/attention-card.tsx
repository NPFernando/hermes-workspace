  ...
  return (
    ...
    >
      <div
        aria-hidden
        className={cn(
          'pointer-events-none absolute -right-10 -top-12 h-32 w-32 rounded-full opacity-15 blur-3xl',
          empty ? 'bg-[var(--theme-success)]' : 'bg-[var(--theme-warning)]',
        )}
      />
      ...
      {empty ? (
        <p className="py-1 text-[11px] text-[var(--theme-muted)]">
