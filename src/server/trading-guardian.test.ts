...
describe('checkOrderProposal', () => {
  ...
  it('does not apply the open-drawdown halt while under the limit', () => {
    const v = checkOrderProposal(proposal, { ...baseCtx, openUnrealizedPnlQuote: -20 })
...
describe('helpers', () => {
  ...
  it('weekKey buckets by UTC ISO week', () => {
    ...
    expect(weekKey('2026-07-06T00:00:00Z')).toBe(weekKey('2026-07-10T23:00:00Z'))
    expect(weekKey('2026-07-05T00:00:00Z')).not.toBe(weekKey('2026-07-13T00:00:00Z'))
