          ...
          <div className="flex items-center gap-2">
            <label className="block">
              <input
                ...
                className="block w-full cursor-pointer text-xs text-[var(--theme-muted)] md:max-w-xs file:mr-2 file:cursor-pointer file:rounded-md file:border file:border-[var(--theme-border)] file:bg-[var(--theme-hover)] file:px-2.5 file:py-1.5 file:text-xs file:font-medium file:text-[var(--theme-text)] file:transition-colors hover:file:bg-[var(--theme-hover)] disabled:cursor-not-allowed disabled:opacity-50"
              />
            </label>
            <Button
              variant="outline"
