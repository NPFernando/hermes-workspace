...
| `src/lib/update-notes.ts` | New: shared release-notes types + localStorage seen-state (`storeNotes`, `markNotesSeen`), extracted from update-center-notifier | Not yet submitted upstream — good PR candidate | Adopt upstream's version if merged |
